...
public class BenchmarkRunner {
    ...
    public static void main(String[] args) {
        System.out.println("Starting Day 4 Benchmarks...");
        ...
        try {
            runBenchmark("Day 4 Part 1", () -> Day4Part1.main(new String[] {}), nullPrintStream);
            runBenchmark("Day 4 Part 1 Optimized", () -> Day4Part1Optimized.main(new String[] {}),
                    nullPrintStream);
