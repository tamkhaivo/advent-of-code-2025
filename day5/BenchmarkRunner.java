...
public class BenchmarkRunner {
    ...
    public static void main(String[] args) {
        System.out.println("Starting Day 5 Benchmarks...");
        ...
        try {
            runBenchmark("Day 5 Part 1", () -> Day5Part1.main(new String[] {}), nullPrintStream);
            runBenchmark("Day 5 Part 1 VT", () -> Day5Part1VirtualThread.main(new String[] {}), nullPrintStream);

            runBenchmark("Day 5 Part 2", () -> Day5Part2.main(new String[] {}), nullPrintStream);
            runBenchmark("Day 5 Part 2 VT", () -> Day5Part2VirtualThread.main(new String[] {}), nullPrintStream);
